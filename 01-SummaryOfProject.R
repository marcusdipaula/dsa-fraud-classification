...
# 1. Problem statement and comprehension of the context
#     - What am I trying to solve?
#       Predict/prevent potentially fraudulent clicks, characterized by lots of clicks
...
#
#     - What would be the ideal scenario for them?
#       To know, beforehand, who could (has the highest probability of) be a fraud clicker.
